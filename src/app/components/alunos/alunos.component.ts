...
export class AlunosComponent implements OnInit, OnDestroy {
  ...
  public alunoForm: FormGroup | null = null;
  public titulo = 'Alunos';
  //public alunoSelecionado: Aluno | null = null;
  public alunoSelecionado: Aluno | null = new Aluno();
  public textSimple = '';
  ...
  ngOnInit(): void {
    this.pagination = { currentPage: 1, itemsPerPage: 1 } as Pagination;
  ...
  alunoSelect(alunoId: number): void {
    ...
    this.alunoService.getById(alunoId).subscribe(
      (alunoReturn:any) => {
        let nome = alunoReturn.nome.split(' ',2)[0];
        let sobrenome = alunoReturn.nome.split(' ',2)[1];
        console.log(nome + ' ' + sobrenome)
        alunoReturn.nome = nome;
        alunoReturn.sobrenome = sobrenome;
